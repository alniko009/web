...
class Suppliers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, phone, address, photo, about', 'required'),
			array('name, address, photo', 'length', 'max'=>255),
			array('phone', 'length', 'max'=>55),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, phone, address, photo, about', 'safe', 'on'=>'search'),
		);
	}
